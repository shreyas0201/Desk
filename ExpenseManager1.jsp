  ...
  opacity: 0;
    ...
    <body>
     ...
     <a href="#"><i class="fas fa-home"></i><span> Home</span></a>
        ...
        <a href="#"><i class="fas fa-table"></i><span>Dashboard</span></a>
        <a href="#"><i class="fas fa-money-bill-alt"></i><span>Transactions</span></a>
        <a href="#"><i class="fas fa-chart-pie"></i><span>Report</span></a>
                </div>
  ...
  <!-- 5 -->
   ...
   <% if(i < k){%>
        ...
        <% } %>
               ...
               <hr class="line">
               <h5 style="color:skyblue; margin-left:50px; margin-top: 0px"> view all </h5>
